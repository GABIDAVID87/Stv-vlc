...
class ExternalPlayerLauncher(private val activity: Activity) {
    ...
    private fun vlcPlayerIntent(url: String, title: String): Intent =
        Intent(Intent.ACTION_VIEW).apply {
    ...
    fun playM3U(
        ...
        val intent = vlcPlayerIntent(firstUrl, firstTitle).apply {
    ...
    fun play(
        ...
        val intent = vlcPlayerIntent(finalUrl, title).apply {
