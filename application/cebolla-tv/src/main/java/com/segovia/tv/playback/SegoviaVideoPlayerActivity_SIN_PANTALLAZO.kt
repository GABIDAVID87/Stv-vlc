...
class SegoviaVideoPlayerActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        /*
         * Esta Activity solo sirve como puente hacia el VLC integrado.
         * La hacemos invisible para que no llegue a dibujarse durante el
         * salto Segovia TV -> VLC.
         */
    ...
    private fun abrirStartActivityVlc() {
        ...
        try {
            ...
            /*
             * Sin animación: evitamos el flash de la Activity puente.
             */
