    ...
    private fun recibirProgresoRctv(json: String) {
        try {
            ...
            for (i in 0 until a.length()) {
                ...
                // VLC devuelve el estado de toda la playlist de 6 capítulos.
                // "Seguir viendo" debe recibir solamente el capítulo que se
                // estaba reproduciendo al salir del reproductor.
