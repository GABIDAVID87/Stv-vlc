...
class PlaylistAdapter(private val player: IPlayer) : DiffUtilAdapter<MediaWrapper, PlaylistAdapter.ViewHolder>(), SwipeDragHelperAdapter, SchedulerCallback {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        // SEGOVIA TV: el rectángulo amarillo representa ÚNICAMENTE el foco del mando.
        // No lo marcamos como selected porque el capítulo que se está reproduciendo
        // debe quedar identificado solamente por el color amarillo del texto.
        ...
        if (currentIndex == position) {
            ...
            if (segoviaSeries) holder.binding.audioItemTitle.setTextColor(Color.rgb(255, 215, 0))
            ...
            if (segoviaSeries) holder.binding.audioItemTitle.setTextColor(Color.WHITE)
